...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        new Article(author: someone, title: "10 things to blog about", urlTitle: '10-things', text: 'I want to show you 10 things that are worth blogging about.').save(failOnError: true)
        new Article(author: someone, title: "Stuff you should know", urlTitle: 'stuff', text: 'You will not believe this stuff!').save(failOnError: true)
    }
    def destroy = {
    }
}
