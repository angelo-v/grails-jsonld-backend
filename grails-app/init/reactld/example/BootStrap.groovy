...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def article1 = new Article(author: me, title: "Hello World", slug: 'hello-world', text: 'Hello! This is my new blog.').save(failOnError: true)
        ...
        new Comment(article: article1, commenter: new Commenter(name: 'Fritz', email: 'fritz@mail.example'), text: 'Just my 5 cents').save(failOnError: true)
        new Comment(article: article1, commenter: new Commenter(name: 'Harald', email: 'harald@mail.example'), text: 'Hello, want to buy v14gr4?').save(failOnError: true)
